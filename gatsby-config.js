...
module.exports = {
  ...
  siteMetadata: {
    title: `Edgar Martínez`,
    author: `Edgar Martínez`,
    firstName: `Edgar`,
    lastName: `Martínez`,
    description: `Edgar Martínez's personal site`,
    occupation: `Software Engineer`,
    keywords: [`Edgar`, `Edgar Martínez`, `Personal`, `Blog`, `Resume`, `Projects`, `Work`],
    siteUrl:
  ...
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        name: `Edgar Martínez's Personal Site`,
        short_name: `Edgar`,
